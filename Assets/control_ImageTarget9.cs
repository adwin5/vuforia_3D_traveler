...
public class control_ImageTarget9 : MonoBehaviour,  Vuforia.IVirtualButtonEventHandler {
	...
	private GameObject p;
		...
		public void Update()
		{
		  if(control_ImageTarget3.char_1_loc ==9)
			Char2.transform.position = new Vector3 (-509.0f +8.0f , 0.0f, 8.0f);
		  else
			Char2.transform.position = new Vector3 (8.0f , -500.0f, 8.0f);
		
		  if(control_ImageTarget3.char_2_loc ==9)
			Char3.transform.position = new Vector3 (-509.0f +8.0f , 0.0f, -8.0f);
		  else
			Char3.transform.position = new Vector3 (8.0f , -500.0f, -8.0f);
		
		  if(control_ImageTarget3.char_3_loc ==9)
			Char4.transform.position = new Vector3 (-509.0f -8.0f , 0.0f, -5.0f);
		  else
		...
		{
		if (control_ImageTarget3.turn == 1 && control_ImageTarget3.char_1_loc == 9 
			|| control_ImageTarget3.turn == 2 && control_ImageTarget3.char_2_loc == 9
			|| control_ImageTarget3.turn == 3 && control_ImageTarget3.char_3_loc == 9) {
			...
			if (vb.name == "VirtualButton2") {
				...
				Sphere.transform.position = new Vector3 (-509.0f, 0.0f, 0.0f);
				if (control_ImageTarget3.turn == 1) {
					ball.GetComponent<Renderer> ().material.color = Color.red;
					control_ImageTarget3.char_1_money -= control_ImageTarget3.h_price_9;
					control_ImageTarget3.o_house_9 = 1;
					control_ImageTarget3.h_price_9 += 500;//house price increase
				} else if (control_ImageTarget3.turn == 2) {
					ball.GetComponent<Renderer> ().material.color = Color.blue;
					control_ImageTarget3.char_2_money -= control_ImageTarget3.h_price_9;
					control_ImageTarget3.o_house_9 = 2;
					control_ImageTarget3.h_price_9 += 500;//house price increase
				} else {		
					ball.GetComponent<Renderer> ().material.color = Color.yellow;
					control_ImageTarget3.char_3_money -= control_ImageTarget3.h_price_9;
					control_ImageTarget3.o_house_9 = 3;
					control_ImageTarget3.h_price_9 += 500;//house price increase				
				}
				print ("B");
			}
		...
		{
		  if (control_ImageTarget3.turn == 1) {
		  	if (control_ImageTarget3.o_house_9 == 2 || control_ImageTarget3.o_house_9 == 3)
				control_ImageTarget3.char_1_money -= (int)(control_ImageTarget3.h_price_9 / 4);
		 } else if (control_ImageTarget3.turn == 2) {
			if (control_ImageTarget3.o_house_9 == 1 || control_ImageTarget3.o_house_9 == 3)
				control_ImageTarget3.char_2_money -= (int)(control_ImageTarget3.h_price_9 / 4);
		 } else {
			if (control_ImageTarget3.o_house_9 == 1 || control_ImageTarget3.o_house_9 == 2)
				control_ImageTarget3.char_3_money -= (int)(control_ImageTarget3.h_price_9 / 4);//**
		 }
