...
public class control_ImageTarget8 : MonoBehaviour,  Vuforia.IVirtualButtonEventHandler {
	...
	public void Update()
	{
		if(control_ImageTarget3.char_1_loc ==8)
			Char2.transform.position = new Vector3 (-444.0f +8.0f , 0.0f, 8.0f);
		else
			Char2.transform.position = new Vector3 (8.0f , -500.0f, 8.0f);
		
		if(control_ImageTarget3.char_2_loc ==8)
			Char3.transform.position = new Vector3 (-444.0f +8.0f , 0.0f, -8.0f);
		else
			Char3.transform.position = new Vector3 (8.0f , -500.0f, -8.0f);
		
		if(control_ImageTarget3.char_3_loc ==8)
			Char4.transform.position = new Vector3 (-444.0f -8.0f , 0.0f, -5.0f);
		else
			Char4.transform.position = new Vector3 (-88.0f , -500.0f, -5.0f);

		p.GetComponent<TextMesh>().text = control_ImageTarget3.h_price_8.ToString()+"$";
	...
	{
		if (control_ImageTarget3.turn == 1 && control_ImageTarget3.char_1_loc == 8 
			|| control_ImageTarget3.turn == 2 && control_ImageTarget3.char_2_loc == 8
			|| control_ImageTarget3.turn == 3 && control_ImageTarget3.char_3_loc == 8) {
			...
			if (vb.name == "VirtualButton2") {
				...
				Sphere.transform.position = new Vector3 (-444.0f, 0.0f, 0.0f);
				if (control_ImageTarget3.turn == 1) {
					ball.GetComponent<Renderer> ().material.color = Color.red;
					//
					control_ImageTarget3.char_1_money -= control_ImageTarget3.h_price_8;
					control_ImageTarget3.o_house_8 = 1;
					control_ImageTarget3.h_price_8 += 500;//house price increase
				} else if (control_ImageTarget3.turn == 2) {
					ball.GetComponent<Renderer> ().material.color = Color.blue;
					//
					control_ImageTarget3.char_2_money -= control_ImageTarget3.h_price_8;
					control_ImageTarget3.o_house_8 = 2;
					control_ImageTarget3.h_price_8 += 500;//house price increase
				} else {
					ball.GetComponent<Renderer> ().material.color = Color.yellow;
					//
					control_ImageTarget3.char_3_money -= control_ImageTarget3.h_price_8;
					control_ImageTarget3.o_house_8 = 3;
					control_ImageTarget3.h_price_8 += 500;//house price increase
	...
	{
		if (control_ImageTarget3.turn == 1) {
			if (control_ImageTarget3.o_house_8 == 2 || control_ImageTarget3.o_house_8 == 3)
				control_ImageTarget3.char_1_money -= (int)(control_ImageTarget3.h_price_8 / 4);
		} else if (control_ImageTarget3.turn == 2) {
			if (control_ImageTarget3.o_house_8 == 1 || control_ImageTarget3.o_house_8 == 3)
				control_ImageTarget3.char_2_money -= (int)(control_ImageTarget3.h_price_8 / 4);
		} else {
			if (control_ImageTarget3.o_house_8 == 1 || control_ImageTarget3.o_house_8 == 2)
				control_ImageTarget3.char_3_money -= (int)(control_ImageTarget3.h_price_8 / 4);//**
		}
