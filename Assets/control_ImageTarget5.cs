...
public class control_ImageTarget5 : MonoBehaviour,  Vuforia.IVirtualButtonEventHandler {
	...
	public void Update()
	{
		if(control_ImageTarget3.char_1_loc ==5)
			Char2.transform.position = new Vector3 (-180.0f +8.0f , 0.0f, 8.0f);
		else
			Char2.transform.position = new Vector3 (8.0f , -500.0f, 8.0f);
		
		if(control_ImageTarget3.char_2_loc ==5)
			Char3.transform.position = new Vector3 (-180.0f +8.0f , 0.0f, -8.0f);
		else
			Char3.transform.position = new Vector3 (8.0f , -500.0f, -8.0f);
		
		if(control_ImageTarget3.char_3_loc ==5)
			Char4.transform.position = new Vector3 (-180.0f -8.0f , 0.0f, -5.0f);
		else
			Char4.transform.position = new Vector3 (-88.0f , -500.0f, -5.0f);

		p.GetComponent<TextMesh>().text = control_ImageTarget3.h_price_5.ToString()+"$";
	...
	public void OnButtonPressed( Vuforia.VirtualButtonAbstractBehaviour vb)
	{
		...
		if (control_ImageTarget3.turn == 1 && control_ImageTarget3.char_1_loc == 5 
			|| control_ImageTarget3.turn == 2 && control_ImageTarget3.char_2_loc == 5
			|| control_ImageTarget3.turn == 3 && control_ImageTarget3.char_3_loc == 5) {
			...
			if (vb.name == "VirtualButton2") {			
				...
				Sphere.transform.position = new Vector3 (-180.0f, 0.0f, 0.0f);

				if (control_ImageTarget3.turn == 1) {
					ball.GetComponent<Renderer> ().material.color = Color.red;
					control_ImageTarget3.char_1_money -= control_ImageTarget3.h_price_5;
					control_ImageTarget3.o_house_5 = 1;
					control_ImageTarget3.h_price_5 += 500;//house price increase
				} else if (control_ImageTarget3.turn == 2) {
					ball.GetComponent<Renderer> ().material.color = Color.blue;
					control_ImageTarget3.char_2_money -= control_ImageTarget3.h_price_5;
					control_ImageTarget3.o_house_5 = 2;
					control_ImageTarget3.h_price_5 += 500;//house price increase
				} else {			
					ball.GetComponent<Renderer> ().material.color = Color.yellow;
					control_ImageTarget3.char_3_money -= control_ImageTarget3.h_price_5;
					control_ImageTarget3.o_house_5 = 3;
					control_ImageTarget3.h_price_5 += 500;//house price increase				
				}
	...
	public void OnButtonReleased( Vuforia.VirtualButtonAbstractBehaviour vb)
	{
		...
		if (vb.name == "VirtualButton2") {
			Sphere.GetComponent<Renderer>().material.color= Color.white;    //change color
			print ("D");}
		print ("turn="+control_ImageTarget3.turn);
		print ("loc="+control_ImageTarget3.char_3_loc);
	...
	private void TimeIsUp()
	{
		...
		if (control_ImageTarget3.turn == 1) {
			if (control_ImageTarget3.o_house_5 == 2 || control_ImageTarget3.o_house_5 == 3)
				control_ImageTarget3.char_1_money -= (int)(control_ImageTarget3.h_price_5 / 4);
		} else if (control_ImageTarget3.turn == 2) {
			if (control_ImageTarget3.o_house_5 == 1 || control_ImageTarget3.o_house_5 == 3)
				control_ImageTarget3.char_2_money -= (int)(control_ImageTarget3.h_price_5 / 4);
		} else {
			if (control_ImageTarget3.o_house_5 == 1 || control_ImageTarget3.o_house_5 == 2)
				control_ImageTarget3.char_3_money -= (int)(control_ImageTarget3.h_price_5 / 4);//**
		}
