...
public class control_ImageTarget4 : MonoBehaviour,  Vuforia.IVirtualButtonEventHandler {
	...
	public void Update()
	{
		...
		if(control_ImageTarget3.char_1_loc ==4)
			Char2.transform.position = new Vector3 (-76.0f +8.0f , 0.0f, 8.0f);
		else
			Char2.transform.position = new Vector3 (8.0f , -500.0f, 8.0f);

		if(control_ImageTarget3.char_2_loc ==4)
			Char3.transform.position = new Vector3 (-76.0f +8.0f , 0.0f, -8.0f);
		else
			Char3.transform.position = new Vector3 (8.0f , -500.0f, -8.0f);
		
		if(control_ImageTarget3.char_3_loc ==4)
			Char4.transform.position = new Vector3 (-76.0f -8.0f , 0.0f, -5.0f);
		else
			Char4.transform.position = new Vector3 (-88.0f , -500.0f, -5.0f);

		p.GetComponent<TextMesh>().text = control_ImageTarget3.h_price_4.ToString()+"$";
	...
	{
		if (control_ImageTarget3.turn == 1 && control_ImageTarget3.char_1_loc == 4 
			|| control_ImageTarget3.turn == 2 && control_ImageTarget3.char_2_loc == 4
			|| control_ImageTarget3.turn == 3 && control_ImageTarget3.char_3_loc == 4) {
		 ...
		 if (vb.name == "VirtualButton1") {
	      ...
	      if (vb.name == "VirtualButton2") {
			...
			Sphere.transform.position = new Vector3 (-76.0f, 0.0f, 0.0f);
			if (control_ImageTarget3.turn == 1) {
				ball.GetComponent<Renderer> ().material.color = Color.red;
				control_ImageTarget3.char_1_money -= control_ImageTarget3.h_price_4;
				control_ImageTarget3.o_house_4 = 1;
				control_ImageTarget3.h_price_4 += 500;//house price increase
			} else if (control_ImageTarget3.turn == 2) {
				ball.GetComponent<Renderer> ().material.color = Color.blue;
				control_ImageTarget3.char_2_money -= control_ImageTarget3.h_price_4;
				control_ImageTarget3.o_house_4 = 2;
				control_ImageTarget3.h_price_4 += 500;//house price increase
			} else {
				ball.GetComponent<Renderer> ().material.color = Color.yellow;
				control_ImageTarget3.char_3_money -= control_ImageTarget3.h_price_4;
				control_ImageTarget3.o_house_4 = 3;
				control_ImageTarget3.h_price_4 += 500;//house price increase
			}
	...
	{
		if (control_ImageTarget3.turn == 1) {
			if (control_ImageTarget3.o_house_4 == 2 || control_ImageTarget3.o_house_4 == 3)
				control_ImageTarget3.char_1_money -= (int)(control_ImageTarget3.h_price_4 / 4);
		} else if (control_ImageTarget3.turn == 2) {
			if (control_ImageTarget3.o_house_4 == 1 || control_ImageTarget3.o_house_4 == 3)
				control_ImageTarget3.char_2_money -= (int)(control_ImageTarget3.h_price_4 / 4);
		} else {
			if (control_ImageTarget3.o_house_4 == 1 || control_ImageTarget3.o_house_4 == 2)
				control_ImageTarget3.char_3_money -= (int)(control_ImageTarget3.h_price_4 / 4);//**
		}
